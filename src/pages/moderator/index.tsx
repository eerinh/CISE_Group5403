...
const User: React.FC = () => {
    ...
    return (
        <div className={styles.container}>
            <NavigationMenuDemo />
            <h3 className="text-2xl text-center font-bold pb-3">Moderator View</h3>
                ...
                <table className={styles.articlesTable}>
                    <thead>
                        <tr>
                            ...
                            <th className={styles.detailsColumn}>Approved</th>
                            <th onClick={() => handleSort("approved")}>Approved</th>
                        </tr>
                    </thead>
                    <tbody>
                        {sortedArticles.map((article) => (
                            <React.Fragment key={article.id}>
                                <tr>
                                    <td>{article.checked == false && <p style={{ color: 'red' }}>New</p>} {article.title}</td> <td>{article.author}</td>
                                    ...
                                    <td className="text-center">{article.approved ? "✔️" : "❌"}</td>
                                    <td className={`justify-center space-y-2 ${styles.detailsColumn}`}>
                                        <Button
                                            className={"w-full"}
